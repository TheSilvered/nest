...
NstEXP bool NstC Nst_vstack_init();
NstEXP bool NstC _Nst_vstack_push(Nst_Obj *obj);
// Pop a value from the value stack and return it
NstEXP Nst_Obj *NstC Nst_vstack_pop();
// Returns the top value of the stack
NstEXP Nst_Obj *NstC Nst_vstack_peek();
// Duplicates the top value of the stack
NstEXP bool NstC Nst_vstack_dup();
// Destroys the value stack
NstEXP void NstC Nst_vstack_destroy();

// New call stack on the heap
NstEXP bool NstC Nst_fstack_init();
...
NstEXP Nst_FuncCall NstC Nst_fstack_pop();
// Returns the top function in the call stack
NstEXP Nst_FuncCall NstC Nst_fstack_peek();
// Destroys the call stack
NstEXP void NstC Nst_fstack_destroy();

// New catch stack on the heap
NstEXP bool NstC Nst_cstack_init();
...
NstEXP Nst_CatchFrame NstC Nst_cstack_peek();
// Returns the top value of the catch stack
NstEXP Nst_CatchFrame NstC Nst_cstack_pop();
// Destroys the catch stack
NstEXP void NstC Nst_cstack_destroy();
