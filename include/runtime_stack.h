 ...
 * @param start: the start postition of the call
 ...
 *
 * @return true on sccess and false on falure. The error is not always set.
 */
 ...
 * empty a frame with an instruction index of -1 is returned. No error is set.
 */
