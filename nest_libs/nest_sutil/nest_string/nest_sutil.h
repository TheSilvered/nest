...
#ifdef NESTSUTIL_EXPORTS
#define NEST_SUTIL_API __declspec(dllexport)
#else
#define NEST_SUTIL_API __declspec(dllimport)
#endif
...
NEST_SUTIL_API bool lib_init();
NEST_SUTIL_API FuncDeclr *get_func_ptrs();
NEST_SUTIL_API INIT_LIB_OBJ_FUNC;
