...
static usize virtual_iof_read_f(void *buf, usize e_size, usize e_count,
...
static usize virtual_iof_write_f(void *buf, usize e_size, usize e_count,
                                 VirtualIOFile_data *f)
{
    if (f == nullptr)
        return 0;
