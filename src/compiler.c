...
static void compile_long_s(Nst_Node *node)
{
    ...
    */
          ...
          cursor = cursor->next )
    {
        ...
        {
            Nst_Inst *inst = nst_new_inst_empty(NST_IC_POP_VAL, 0);
            ADD_INST(inst);
        }
    }
}
...
static void compile_while_l(Nst_Node *node)
{
    ...
    */
    ...
    Nst_Inst *inst;
    Nst_Inst *jump_cond_start = nst_new_inst_empty(NST_IC_JUMP, 0);
...
static void compile_for_as_l(Nst_Node *node)
{
    ...
    */
    ...
    inst = nst_new_inst_int(
        ...
        HEAD_NODE->end);
    ADD_INST(inst);
    Nst_Inst *jump_body_end = nst_new_inst_empty(NST_IC_JUMPIF_T, 0);
...
static void compile_if_e(Nst_Node *node)
{
    ...
    */
    ...
    Nst_Inst *jump_at_end = nst_new_inst_empty(NST_IC_JUMP, 0);
...
static void compile_func_declr(Nst_Node *node)
{
    ...
    */
    ...
    Nst_Inst *inst = nst_new_inst_val(
        NST_IC_PUSH_VAL,
        OBJ(func),
        nst_no_pos(),
        nst_no_pos());
...
static void compile_return_s(Nst_Node *node)
{
    ...
    */
    ...
    compile_node(HEAD_NODE);
    Nst_Inst *inst = nst_new_inst_empty(NST_IC_RETURN_VAL, 0);
    ADD_INST(inst);
}
...
static void compile_stack_op(Nst_Node *node)
{
    ...
    */
    ...
    Nst_Inst *inst = nst_new_inst_int(
        NST_IC_STACK_OP,
        HEAD_TOK->type,
        node->start,
        node->end);
...
static void compile_extract_e(Nst_Node *node)
{
    ...
    */
    ...
    Nst_Inst *inst = nst_new_inst_pos(
        NST_IC_OP_EXTRACT,
        node->start,
        node->end);
    ADD_INST(inst);
...
static void compile_try_catch_s(Nst_Node* node)
{
    ...
    */
    ...
    // block
    Nst_Inst *jump_catch_end = nst_new_inst_empty(NST_IC_JUMP, 0);
